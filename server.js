...
var articles = {
    'article-one' : {
  title:"Article One ! Kuber Nandwani",
  heading: "Article One",
  date:"Sep 5,2016",
  content: `
        <p>
  ...
  `
    ...
    'article-two' : {
  title:"Article Two ! Kuber Nandwani",
  heading: "Article Two",
  date:"Sep 5,2017",
  content: `
        <p>
  ...
  `
    ...
    'article-three' : {
  title:"Article Three ! Kuber Nandwani",
...
function createTemplate(data){
    ...
    <head>
    	...
    	<!--CSS CODE WITHIN STYLE TAG has been pushed to CSS File-->
